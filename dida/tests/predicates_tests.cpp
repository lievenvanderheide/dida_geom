...
TEST_CASE("is_within_with_perturbation(PolygonView2, Point2)")
{
  ...
  SECTION("Unperturbed ray intersects vertices")
  {
  ...
  SECTION("Unperturbed ray intersects horizontal edges")
  {
  ...
  SECTION("Unperturbed point on edge")
  {
    ...
    CHECK(is_within_with_perturbation<PerturbationVector2::left_down>(polygon, Point2(-1, 3)));
    CHECK_FALSE(is_within_with_perturbation<PerturbationVector2::right_up>(polygon, Point2(-1, 3)));

    CHECK_FALSE(is_within_with_perturbation<PerturbationVector2::left_down>(polygon, Point2(-1, 7)));
    CHECK(is_within_with_perturbation<PerturbationVector2::right_up>(polygon, Point2(-1, 7)));
  }
