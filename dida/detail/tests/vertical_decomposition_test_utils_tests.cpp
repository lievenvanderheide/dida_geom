  ...
  SECTION("Node towards left")
  {
    ...
    SECTION("Branch 0")
    {
      NodeBranchBoundaryVertices result =
          node_branch_boundary_vertices(vertices, ChainDecomposition{nullptr, nullptr}, &node, 0);
    ...
    {
      NodeBranchBoundaryVertices result =
          node_branch_boundary_vertices(vertices, ChainDecomposition{nullptr, nullptr}, &node, 1);
    ...
    {
      NodeBranchBoundaryVertices result =
          node_branch_boundary_vertices(vertices, ChainDecomposition{nullptr, nullptr}, &node, 2);
    ...
    {
      NodeBranchBoundaryVertices result =
          node_branch_boundary_vertices(vertices, ChainDecomposition{&node, nullptr}, &node, 1);
      CHECK(result.lower_boundary_vertex_it == vertices.begin() + 3);
      CHECK(result.upper_boundary_vertex_it == vertices.begin() + 10);
    }
    ...
    {
      NodeBranchBoundaryVertices result =
          node_branch_boundary_vertices(vertices, ChainDecomposition{&node, nullptr}, &node, 2);
    ...
    {
      NodeBranchBoundaryVertices result =
          node_branch_boundary_vertices(vertices, ChainDecomposition{nullptr, &node}, &node, 1);
      CHECK(result.lower_boundary_vertex_it == vertices.begin() + 3);
    ...
    {
      NodeBranchBoundaryVertices result =
          node_branch_boundary_vertices(vertices, ChainDecomposition{nullptr, &node}, &node, 2);
      CHECK(result.lower_boundary_vertex_it == vertices.begin() + 10);
      CHECK(result.upper_boundary_vertex_it == vertices.begin() + 4);
    }
  }
